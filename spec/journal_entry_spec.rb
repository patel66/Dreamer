...
module DMR
  ...
  describe 'Journal' do
    ...
    it 'Can take in data' do
      journal = JournalEntry.new({user_id: 1, user_name: "Zeus",  creation_date: Time.new(2014,4,7,9,30), title: "Thoughts", entry: "Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah ", entry_type: 'Thought Dump' })
